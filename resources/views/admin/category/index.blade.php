                            ...
                            <table class="table">
                                ...
                                @foreach($category as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{{$item->jadwal->count()}}</td>
                                        <td style="text-align: center">{{$item->publishedJadwal->count()}}</td>
                                        <td style="text-align: center">{{$item->unPublishedJadwal->count()}}</td>
                                        <td align="right">
