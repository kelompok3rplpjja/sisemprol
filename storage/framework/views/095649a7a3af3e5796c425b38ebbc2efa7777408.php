                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="pull-right" style="margin-right: 20px">
                            <a href="<?php echo e(url('/user')); ?>" title="Back">
                                <button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"
                                                                          aria-hidden="true"></i> Back
                                </button>
                            </a>
                            <a href="<?php echo e(url('/user/' . $user->id . '/edit')); ?>" title="Edit User">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"
                                                                          aria-hidden="true"></i> Edit
                                </button>
                            </a>

                            <form method="POST" action="<?php echo e(url('user' . '/' . $user->id)); ?>" accept-charset="UTF-8"
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('user.update_pass' , $user->id)); ?>"
